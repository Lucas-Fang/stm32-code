...
{
    /*navagition test data*/
//            memcpy(&robot.chassic.Chassic_Move_Data.vx,&datas[0],4);
//            memcpy(&robot.chassic.Chassic_Move_Data.vy,&datas[4],4);
//            memcpy(&robot.chassic.Chassic_Move_Data.vomega,&datas[8],4); 
            /*navagition test data*/

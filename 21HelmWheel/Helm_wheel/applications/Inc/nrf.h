...
//NRF24L01引脚
#define NRF24L01_CE_HIGH    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, GPIO_PIN_SET)    
#define NRF24L01_CE_LOW     HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, GPIO_PIN_RESET) 
#define NRF24L01_CSN_HIGH    HAL_GPIO_WritePin(GPIOC, GPIO_PIN_4, GPIO_PIN_SET)
#define NRF24L01_CSN_LOW     HAL_GPIO_WritePin(GPIOC, GPIO_PIN_4, GPIO_PIN_RESET)
#define NRF24L01_IRQ        HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_4)
...
uint8_t NRF24L01_RxPacket(uint8_t *rxbuf);//接收一个包的数据
 void decode(const uint8_t *input, int16_t *output) ;

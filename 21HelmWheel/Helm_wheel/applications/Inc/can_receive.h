...
class CAN_BUS
{
	public:
		...
		{
			public:
				void CAN1_Front_gm3508(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4);
				void CAN1_Behind_gm6020(int16_t motor5, int16_t motor6, int16_t motor7, int16_t motor8);

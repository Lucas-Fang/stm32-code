...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
	...
	//r2
		// if (j == 1) // 对对应的6020设置0位置的偏移量
		// {

		// 	can_bus.motor_6020[j].angle += 8191 /3;
		// }
		
		// if (j == 0) // 对对应的6020设置0位置的偏移量
		// {

		// 	can_bus.motor_6020[j].angle += 8191*5/6 ;

		// }
		// if (j == 2) // 对对应的6020设置0位置的偏移量
		// {

		// 	can_bus.motor_6020[j].angle += 8191 *7/ 12;
		...
		//r1
			...
			// }
	  		// if( j==0)//对对应的6020设置0位置的偏移量
	 	 	// {
			//    		 can_bus.motor_6020[j].angle +=8191*8/12;
			// }
		  	// if( j==2)//对对应的6020设置0位置的偏移量
		  	// {
			// 	 can_bus.motor_6020[j].angle +=8191*3/12;
 			// }

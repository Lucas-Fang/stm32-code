...
{    
	...
	NRF24L01_CE_LOW;                        //NRF24L01_CE=0; 使能24L01
	NRF24L01_CSN_HIGH;                       //NRF24L01_CSN=1; SPI片选取消	 		 	 
}
...
uint8_t NRF24L01_Read_Reg(uint8_t reg)
{
	uint8_t reg_val;	
   	...
   	NRF24L01_CSN_LOW;                          //NRF24L01_CSN=0;  使能SPI传输		
  	SPI3_ReadWriteByte(reg);           //发送寄存器号
  	reg_val=SPI3_ReadWriteByte(0XFF);  //读取寄存器内容
  	NRF24L01_CSN_HIGH;                        //NRF24L01_CSN=1;  禁止SPI传输		    

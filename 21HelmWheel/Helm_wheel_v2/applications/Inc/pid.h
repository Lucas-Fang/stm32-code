	...
	public:
		...
		class CAN_MOTOR
		{
			public:
				...
				fp32 GM6020_Velocity_Realize(fp32 set_speed,int i);
				fp32 GM6020_Position_Realize_1(fp32 set_pos,int i);
				fp32 GM6020_VP_Dual_Loop_Realize_1(fp32 set_pos,int i);

				fp32 GM6020_Velocity_Realize_2(fp32 set_speed,int i);
				fp32 GM6020_Position_Realize_2(fp32 set_pos,int i);
				fp32 GM6020_VP_Dual_Loop_Realize_2(fp32 set_pos,int i);
		}can_motor;

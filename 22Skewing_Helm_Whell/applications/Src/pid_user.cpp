...
//电机PID三参
fp32 motor_speed_3508_pid1[3] = {20, 0.001, 15};//底盘3508参数
fp32 motor_speed_3508_pid2[3] = {20, 0.001, 15};//底盘3508参数
fp32 motor_speed_3508_pid3[3] = {18, 0.001, 15};//底盘3508参数
...
/**
 * @brief       6020速度环   (!!!:6020_max_speed = 320rpm)
 * @param       set_speed：速度值
 * @param       i：以数组为序号的，也就是i=电调ID号-1
 * @retval      输出值
 * @note        输出值究竟是什么值，需要看该函数的输出值被当作了什么量
